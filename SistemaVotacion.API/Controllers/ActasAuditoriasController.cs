...
namespace SistemaVotacion.API.Controllers
{
    ...
    public class ActasAuditoriasController : ControllerBase
    {
        ...
        {
            return await _context.ActaAuditoria.ToListAsync();
        }
        ...
        {
            var actaAuditoria = await _context.ActaAuditoria.FindAsync(id);
        ...
        {
            _context.ActaAuditoria.Add(actaAuditoria);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteActaAuditoria(int id)
        {
            ...
            _context.ActaAuditoria.Remove(actaAuditoria);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.ActaAuditoria.Any(e => e.Id == id);
        }
    }
}
