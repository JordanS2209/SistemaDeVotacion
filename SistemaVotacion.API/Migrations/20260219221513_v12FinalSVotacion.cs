...
{
    /// <inheritdoc />
    public partial class v12FinalSVotacion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdProceso = table.Column<int>(type: "integer", nullable: false),
                    IdLista = table.Column<int>(type: "integer", nullable: true),
                    IdDignidad = table.Column<int>(type: "integer", nullable: true),
                    IdOpcion = table.Column<int>(type: "integer", nullable: true),
                    IdPregunta = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
